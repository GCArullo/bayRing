...
class NR_simulation():
    ...
    def __init__(self                                           , 
        ...
        self.injection_model_parameters.setdefault('TEOB-NR-fit', 0)
        self.injection_model_parameters.setdefault('TEOB-qc-fit-type', 'equal-mass')
        self.injection_model_parameters.setdefault('sigmoid-flag', 0)
        self.injection_model_parameters.setdefault('quadratic-fits', 0)
        ...
        if(injection_utils.is_injection_catalog(self.NR_catalog)):
            ...
            injection_model = template_waveforms.WaveformModel(
                ...
                TEOB_NR_fit               = self.injection_model_parameters['TEOB-NR-fit'],
                TEOB_qc_fit_type          = self.injection_model_parameters['TEOB-qc-fit-type'],
                sigmoid_flag              = self.injection_model_parameters['sigmoid-flag'],
                quadratic_fits            = self.injection_model_parameters['quadratic-fits'],
            )
