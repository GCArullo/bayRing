...
.. list-table::
   ...
   * - ``TEOB-NR-fit``
     - ``0``
     - Development flag to sample TEOB NR calibration coefficients.
   * - ``sigmoid-flag``
     - ``0``
     - Development flag for TEOB sigmoid corrections.
   * - ``quadratic-fits``
     - ``0``
     - Development flag for TEOB quadratic fits.
   * - ``TEOB-qc-fit-type``
     - ``equal-mass``
     - Development fit type: ``equal-mass`` or ``non-spinning``.
